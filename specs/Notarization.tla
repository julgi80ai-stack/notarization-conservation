--------------------------- MODULE Notarization ---------------------------
(***************************************************************************)
(* Phase 2 (L2): the ABSTRACT class of label-independent notarization.     *)
(*                                                                         *)
(* This lifts Proposition 1 from the Morpheus instance (SepClosure model)   *)
(* to a                                                                    *)
(* CLASS-level theorem: any system whose re-linking surfaces are            *)
(* label-independent in the sense below.  Purely relational / set-theoretic *)
