...
(*                                                                         *)
(* Three machines, switched by CONSTANT Machine, each checked with TLC:     *)
...
(*                                                                         *)
(* Code anchors (audited system):                                          *)
(*   J1 hash chain     chronos/chain.py:50,59,184-209                       *)
(*   J2 time-series    event_logger.py:191 ; time_series_storage.py:33,68   *)
(*   J4 parent key     types.py:45 (parent_corr_id); set at                 *)
(*                     will/engine.py:218, c4_facade.py:276 (no traverser).  *)
(***************************************************************************)
...
(*  sep_ACCT_chronos.cfg    (J2 off)    -> VIOLATED via JoinByPosition *)
(*                          (the hash chain ALONE re-links; label moot)*)
(*  sep_ACCT_nosurface.cfg  (J1+J2 off) -> NO ERROR                    *)
(*                          (cause = the surfaces, not the label)      *)
(*  sep_NE_KEEP.cfg                     -> VIOLATED via JoinByParent    *)
